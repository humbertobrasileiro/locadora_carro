                        ...
                        <div class="col-4">
                            <input-container-component titulo="ID Marca" id="newMarca_id" id-help="newMarca_idHelp" texto-ajuda="Selecione a marca">
                                <select
                                    class="form-control"
                                    id="newMarca_id"
                                    aria-describedby="newMarca_idHelp"
            ...
            <modal-component id="modalModeloVis" titulo="Visualizar | modelo" tamanho="modal-xl">
                ...
                <template v-slot:conteudo>
                    ...
                    <div class="form-group row" v-if="$store.state.item.chave >= 0">
                        ...
                        <div class="col-6" v-if="imagem.logo != ''">
                            <img :src="'/storage/' + imagem.logo">
                        </div>
                    </div>
        ...
        computed: {
            upLoadImage() {
                if (this.$store.state.item.imagem != null) {
                    ...
                    this.imagem['nomeMarca'] = this.modelos.data[this.$store.state.item.chave].marca.nome
                }
            }
        },
        data() {
            return {
                ...
                imagem: { caminho: '', arquivo: [], titulo: '', url: '', logo: '', nomeMarca: '' },
                pagina: '',
                marcas: []
            }
        },
