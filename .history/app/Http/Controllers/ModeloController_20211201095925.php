...
class ModeloController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('atributos_marca')) {
            ...
            $modeloRepository->selAtribRegRelac($atributos_marca);

        } else {

            $modeloRepository->selAtribRegRelac('marca');
        ...
        return response()->json($modeloRepository->getResultadoPaginado(4), 200);
