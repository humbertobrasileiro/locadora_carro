...
<head>
	<meta charset="UTF-8">
	<title>Eco Living Website Template</title>
	<link rel="stylesheet" href="css/app.css" type="text/css">
</head>
<body>
	<div id="antialiased">
		<div>
			<a href="index.html" id="logo"><img src="images/novalogo.png" alt="logo"></a>
			<ul>
				<li class="selected">
	...
	<div id="body" class="max-w-6xl mx-auto sm:px-6 lg:px-8">
		<div class="blog">
