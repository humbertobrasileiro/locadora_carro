                ...
                <modal-component id="modalModeloAtu" titulo="Atualizar | modelo" tamanho="modal-xl">
                    ...
                    <template v-slot:conteudo>
                        <div class="form-group row">
                            ...
                            <div class="col-2">
                                <img :src="'/storage/' + imagem.logo" width="50" height="auto">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-6">
                                <input-container-component
                                    titulo="Modelo da marca (clique aqui para alterar)"
                                    id="imagem"
                                    id-help="imagemHelp"
                            ...
                            <div class="col-6">
                                <img :src="imagem.url" :alt="imagem.titulo" v-if="imagem.url" display="block" align="center" width="420" height="auto">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-3">
    ...
    export default {
        ...
        methods: {
            ...
            atuLogo() {
                ...
                console.log('id: ', this.$store.state.item.marca_id, this.marcas)
                let m = this.marcas

                let minha_marca = m.filter(function(elem) {
                    if (elem.id == this.$store.state.item.marca_id) return elem.imagem;
                })

                console.log('eis me aqui', minha_marca)

                his.imagem['logo'] = minha_marca
            },
            carregarImagem(e) {
