    ...
    <div class="form-row ml-2">
        ...
        <div class="col-9">
            ...
            <!--div class="row justify-content-center"-->
                ...
                <modal-component id="modalModeloAtu" titulo="Atualizar | modelo" tamanho="modal-lg">
                    ...
                    <template v-slot:conteudo>
                        <div class="form-group row">
                            ...
                            <input-container-component titulo="ID Marca" id="newMarca_id" id-help="newMarca_idHelp" texto-ajuda="Informe o ID da marca">
                                <div class="col-10">
                                    <select v-model="$store.state.item.marca_id">
                                        <option value=""></option>
                                        <option v-for="(marca, key) in marcas" :key="key" v-bind:value="marca.id">{{ marca.nome }}</option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            <input-container-component titulo="Modelo da marca (clique aqui para alterar)" id="imagem" id-help="imagemHelp" texto-ajuda="Selecione uma imagem no formato PNG">
                                <img :src="imagem.url" :alt="imagem.titulo" v-if="imagem.url" width="420" height="auto">
                                <br>
                                <input
                                    type="file"
                                    class="form-control-file"
