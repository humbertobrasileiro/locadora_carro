                ...
                if (confirma) {
                    ...
                    axios.post(url, formData, config)
                        .then(response => {
                            ...
                            console.log(this.$store.state.paginaAtual)

                            this.urlPaginacao = 'page=1'

                            this.carregarLista()

                            console.log('Ultima: ' + this.$store.state.ultimaPagina, 'Atual: ' + this.$store.state.paginaAtual)

                            if (this.$store.state.ultimaPagina < this.$store.state.paginaAtual) {
                                this.urlPaginacao = 'page=' + this.$store.state.ultimaPagina
                            } else {
                            ...
                            this.carregarLista(this.urlPaginacao);
