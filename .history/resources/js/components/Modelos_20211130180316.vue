        ...
        <div class="col-3">
            ...
            <card-component titulo="Busca de modelos de carro">
                <template v-slot:conteudo>
                    ...
                    <input-label-component para="inputAir_bag" titulo="Se tem Airbag">
                        <input
                            type="checkbox"
                            class="form-control"
                            id="inputAir_bag"
                            placeholder="Airbag - opcional"
                            v-model="busca.air_bag">
                    </input-label-component>

                                                    <input-grupo-component label="new_Abs" titulo="tem Abs?">
                                    <input
                                        type="checkbox"
                                        id="new_Abs"
