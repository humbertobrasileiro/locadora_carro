                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                <p>
                                    ...
                                    {{ $store.state.item.chave != '' ? modelos.data[$store.state.item.chave].marca.nome : '' }}
                                </p>
                            </div>
                            <div class="col-6">
                                <img :src="  $store.state.item.chave != '' ? '/storage/' + modelos.data[$store.state.item.chave].marca.imagem : ''" alt="Foto do modelo" v-if="modelos.data[$store.state.item.chave].marca.imagem">
                            </div>
                        </div>
