                    ...
                    <card-component titulo="Relação de Modelos de Carro">
                        <template v-slot:conteudo>
                            <table-component
                                ...
                                :titulos="{
                                    id: {titulo: 'ID', tipo: 'texto', path: ''},
                                    marca_id: {titulo: 'ID da marca', tipo: 'texto', path: ''},
                                    nome: {titulo: 'Nome do modelo', tipo: 'texto', path: ''},
                                    imagem: {titulo: 'Imagem', tipo: 'imagem', path: '/storage/modelos/'},
                                    numero_portas: {titulo: 'Nº portas', tipo: 'texto', path: ''},
                                    numero_portas: {titulo: 'Nº portas', tipo: 'texto', path: ''},
                                    lugares: {titulo: 'Nº lugares', tipo: 'texto', path: ''},
                                    air_bag: {titulo: 'Tem air bag', tipo: 'checkbox', path: ''},
                                    abs: {titulo: 'Tem abs', tipo: 'checkbox', path: ''},
                                    created_at: {titulo: 'Criação', tipo: 'data', path: ''}
                                }"
                            ></table-component>
                        </template>
