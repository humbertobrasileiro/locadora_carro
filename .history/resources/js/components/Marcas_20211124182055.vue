                    ...
                    <div class="col-10">
                        <input-container-component titulo="Nome da marca" id="nome" id-help="nomeHelp" texto-ajuda="Informe o nome da marca">
                            <input
                                ...
                                v-model="nomeMarca" :value="$store.state.item.nome">
                        </input-container-component>
                    </div>
                </div>
                <div class="form-group">
                    <input-container-component titulo="Imagem" id="imagem" id-help="imagemHelp" texto-ajuda="Selecione uma imagem no formato PNG">
                        <input
                            type="file"
                            class="form-control-file"
                            id="imagem"
