            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component titulo="Logomarca" id="imagem" id-help="imagemHelp" texto-ajuda="Selecione uma imagem no formato PNG">
                        <img :src="imagem.url" :alt="imagem.titulo" v-if="$store.state.item.imagem">
                        <br>
                        <input
                            type="file"
                            class="form-control-file"
                            ...
                            aria-describedby="novoImagemHelp"
                            placeholder="Selecione uma imagem"
                            v-show="seleciona($store.state.item.imagem)"
                            @change="carregarImagem($event.target.files)">
                    </input-container-component>
                </div>
            </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            seleciona(e) {
                this.arquivoImagem[0] = '/storage/' + e
                this.carregarImagem(this.arquivoImagem[0])
            },
            carregarImagem(e) {
                console.log(e)
