        ...
        <modal-component id="modalMarcaAdc" titulo="Adicionar | marca">
            ...
            <template v-slot:rodape>
                <button
                    ...
                    data-dismiss="modal"
                    @click="$store.state.transacao.status == 'sucesso' ? paginacao(ultimaPagina) : ''">
                    Fechar
                </button>
        ...
        methods: {
                ...
                if (confirma) {
                    ...
                    axios.post(url, formData, config)
                        .then(response => {
                            ...
                            // Pagina antes de remover
                            this.$store.status.paginaAtual = this.marcas.current_page
            ...
            paginacao(l) {
                if (l) {
                    ...
                    console.log(this.marcas.last_page, this.$store.state.paginaAtual)

                            // if (this.marcas.last_page < $store.state.paginaAtual) {
                            //     irParaPagina = this.marcas.last_page
                            // }

                            // this.urlPaginacao = 'page=' + irParaPagina
            ...
            carregarLista() {
                ...
                axios.get(url, config)
                    .then(response => {
                        ...
                        this.$store.paginaAtual = this.marcas.current_page
                    })
                    .catch(errors => {
                        this.$store.state.transacao.status = 'erro'
