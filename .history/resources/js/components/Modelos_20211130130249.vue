            ...
            <!--div class="row justify-content-center"-->
                ...
                <modal-component id="modalModeloAtu" titulo="Atualizar | modelo" tamanho="modal-xl">
                    ...
                    <template v-slot:conteudo>
                        ...
                        <hr>
                        <div class="form-group">
                            <input-container-component titulo="Modelo da marca (clique aqui para alterar)" id="imagem" id-help="imagemHelp" texto-ajuda="Selecione uma imagem no formato PNG">
                                <input
                                    type="file"
                                    class="form-control-file"
                                    id="imagem"
                        ...
                        <div class="form-group row">
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputNumeroPortas">Nº de Portas</label>
                                    </div>
                                    <input
                                        type="number"
                                        class="form-control"
                            ...
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputLugares">Nº de Lugares</label>
                                    </div>
                                    <input
                                        type="number"
                                        class="form-control"
                            ...
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    ...
                                    <input readonly type="text" class="form-control" :aria-label="air_bag" value="Informe se tem Airbag">
                                </div>
                            </div>
                           <div class="col-3">
                                <div class="input-group mb-3">
                                    ...
                                    <input readonly type="text" class="form-control" :aria-label="abs" value="Informe se tem freios ABS">
                                </div>
                            </div>
                        </div>
                    </template>
