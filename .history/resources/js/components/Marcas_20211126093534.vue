<template v-on="upLoadImage">
    <div class="container">
        ...
        <modal-component id="modalMarcaAtu" titulo="Atualizar | marca" :pagina="marcas.current_page">
    ...
    export default {
        ...
        methods: {
            ...
            carregarLista() {
                ...
                axios.get(url, config)
                    .then(response => {
                        ...
                        this.pagAtual = this.marcas.current_page
                    })
                    .catch(errors => {
                        this.$store.state.transacao.status = 'erro'
                        this.$store.state.transacao.mensagem = errors.response.data.erro
            ...
            closeBotao() {
                ...
                if (this.marcas.last_page <= this.pagAtual) {

                   this.urlPaginacao = 'page=' + this.marcas.last_page

                } else {

                   this.urlPaginacao = 'page=' + this.pagAtual
