<template>
    <div class="container">
        ...
        <modal-component id="modalMarcaAdc" titulo="Adicionar | marca">
            ...
            <template v-slot:rodape>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="aposAdic()">Fechar</button>
...
import Paginate from './Paginate.vue'
  ...
  components: { Paginate },
        ...
        methods: {
            ...
            aposAdic() {
                this.carregarLista()
                this.paginacao('page='+this.ultimaPagina)
            },
            paginacao(l) {
                if (l.url) {
            ...
            carregarLista() {
                ...
                axios.get(url, config)
                    .then(response => {
                        ...
                        this.ultimaPagina = this.marcas.last_page
