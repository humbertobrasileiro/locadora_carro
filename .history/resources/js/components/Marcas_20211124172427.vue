<template>
    <div class="container">
        ...
        <modal-component id="modalMarcaAdc" titulo="Adicionar | marca">
            ...
            <template v-slot:rodape>
                <button
                    ...
                    data-dismiss="modal"
                    @click="$store.state.transacao.status == 'sucesso' ? paginacao('page='+$store.state.ultimaPagina) : ''">
                    Fechar
                </button>
        ...
        <modal-component id="modalMarcaRem" titulo="Remover | marca">
            ...
            <template v-slot:rodape>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="closeRemover()">Fechar</button>
  ...
  components: { Paginate },
        ...
        methods: {
            ...
            closeRemover() {
                ...
                let my = this.marcas.last_page

                console.log('Ultima Pagina: ' + my, 'Pagina Atual: ' + this.$store.state.paginaAtual)

                if (my < this.$store.state.paginaAtual) {

                    this.urlPaginacao = 'page=' + my
