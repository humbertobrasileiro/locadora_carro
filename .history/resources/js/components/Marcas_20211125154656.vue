    ...
    export default {
        ...
        computed: {
            ...
            upLoadImage() {
                if (this.$store.state.item.imagem != null) {
                    ...
                    var f = new File([''], this.$store.state.item.imagem, {type: "image/png"})
                    console.log(f)
                    this.imagem['caminho'] = '/storage/'
                    this.imagem['arquivo'] =  f
                    this.imagem['titulo'] = 'imagem do ' + this.imagem['arquivo'].name
                    this.imagem['url'] = this.imagem['caminho'] + this.imagem['arquivo'].name

                    document.getElementById("imagem").src = this.imagem['arquivo'].name
        ...
        methods: {
            carregarImagem(e) {
                ...
                this.imagem['titulo'] = 'imagem do ' + this.figura[0].name
                this.imagem['url'] = this.imagem['caminho'] + this.imagem['arquivo'].name
            ...
            atualizar() {
                console.log('-----')
                console.log(this.imagem['arquivo'])

                let meuarquivo = document.getElementById("imagem").value
                let formData = new FormData();
                formData.append('_method', 'patch')
                formData.append('nome', this.$store.state.item.nome)
                formData.append('imagem', meuarquivo) // this.imagem['arquivo']
