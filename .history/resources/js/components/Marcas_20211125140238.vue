    ...
    export default {
        ...
        computed: {
            ...
            upLoadImage() {
                ...
                this.imageBuff = this.$store.state.item.imagem

                reader.onload = (e) => {
                    this.image = e.target.result;
                };
                reader.readAsDataURL(this.$store.state.item.imagem);

                    document.getElementById('imagem').value = '/storage/' + this.$store.state.item.imagem
