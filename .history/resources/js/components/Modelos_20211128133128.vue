                        ...
                        <div class="form-row">
                            ...
                            <div class="col mb-3">
                                <input-container-component titulo="Tem air bag" id="inputAir_bag" id-help="air_bagHelp" texto-ajuda="Opcional. Tem air bag">
                                    <input type="check" class="form-control" id="inputAir_bag" aria-describedby="air_bagHelp" placeholder="Air bag" v-model="busca.air_bag">
                                </input-container-component>
                            </div>
                            <div class="col mb-3">
                                <input-container-component titulo="Tem abs" id="inputAbs" id-help="absHelp" texto-ajuda="Opcional. Tem abs">
                                    <input type="check" class="form-control" id="inputAbs" aria-describedby="absHelp" placeholder="Abs" v-model="busca.abs">
                                </input-container-component>
                            </div>
                    </template>
