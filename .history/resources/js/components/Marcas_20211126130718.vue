           ...
           /* carregarLista() {
                ...
                axios.get(url, config)
                    .then(response => {
                        ...
                        this.ultima = response.data.last_page

                        console.log('Pagina: '+this.pagina,'Ultima: '+this.ultima)
                    })
                    .catch(errors => {
                        this.$store.state.transacao.status = 'erro'
                        this.$store.state.transacao.mensagem = errors.response.data.erro
            ...
            closeRemoveBotao() {
                ...
                console.log('atual', this.pagina)
                let atual = this.pagina
            ...
            closeBotao() {
                ...
                console.log('Pagina chamada: '+this.pagina)
                console.log('Ultima: '+ this.ultima)

                if (this.ultima <= this.pagina) {

                   this.urlPaginacao = 'page=' + this.ultima
