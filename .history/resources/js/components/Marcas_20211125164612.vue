    ...
    export default {
        ...
        methods: {
            carregarImagem(e) {
                ...
                this.imagem['arquivo'] = e.target.files[0]
                ...
                if (confirma) {
                    ...
                    axios.post(url, formData, config)
                        .then(response => {
                            ...
                            this.paginaAtual = this.marcas.current_page
            ...
            closeBotao() {
                ...
                if (this.marcas.last_page <= this.paginaAtual) {

                    this.urlPaginacao = 'page=' + this.marcas.last_page

                } else {

                    this.urlPaginacao = 'page=' + this.paginaAtual
