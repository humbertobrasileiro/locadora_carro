    ...
    export default {
        ...
        methods: {
            ...
            carregarLista() {
                ...
                axios.get(url, config)
                    .then(response => {
                        ...
                        this.$store.state.pagina = this.marcas.current_page
                    })
                    .catch(errors => {
                        this.$store.state.transacao.status = 'erro'
                        this.$store.state.transacao.mensagem = errors.response.data.erro
            ...
            closeRemoveBotao() {
                ...
                let atual = this.$store.state.pagina

                this.urlPaginacao = 'page=1'
                this.carregarLista()

                this.$store.state.pagina = atual

                console.log('Pagina chamada: '+this.$store.state.pagina)
                console.log('Ultima: '+ this.marcas.last_page)

                if (this.marcas.last_page <= this.$store.state.pagina) {

                   this.urlPaginacao = 'page=' + this.marcas.last_page

                } else {

                   this.urlPaginacao = 'page=' + this.$store.state.pagina
