        ...
        <modal-component id="modalMarcaAdc" titulo="Adicionar | marca">
            ...
            <template v-slot:rodape>
                <button
                    ...
                    data-dismiss="modal"
                    @click="$store.state.transacao.status == 'sucesso' ? paginacao($store.state.ultimaPagina) : ''">
                    Fechar
                </button>
                ...
                if (confirma) {
                    ...
                    axios.post(url, formData, config)
                        .then(response => {
                            ...
                            console.log('Ultima: ' + this.marcas.last_page, 'Atual: ' + this.$store.state.paginaAtual)
            ...
            carregarLista() {
                ...
                axios.get(url, config)
                    .then(response => {
                        ...
                        this.$store.state.ultimaPagina = this.urlBase + '?' +'page='+this.marcas.last_page + this.urlFiltro
                    })
                    .catch(errors => {
                        this.$store.state.transacao.status = 'erro'
