                ...
                <modal-component id="modalModeloVis" titulo="Visualizar | modelo">
                    ...
                    <template v-slot:conteudo>
                        <div class="form-group row">
                            <div class="col-4">
                                <span v-if="$store.state.item.marca_id > 0 ? carregarMarcas($store.state.item.marca_id) : false"></span>
        ...
        methods: {
            carregarMarcas(e) {
                ...
                if (e != '') {
                    ...
                    url = 'http://localhost:8000/api/v1/marca/' + e

                } else {

                    url = 'http://localhost:8000/api/v1/marcas'
