                ...
                <modal-component id="modalModeloAtu" titulo="Atualizar | modelo" tamanho="modal-xl">
                    ...
                    <template v-slot:conteudo>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-3">
                                <input-container-component titulo="Freios ABS" id="abs" id-help="absHelp" texto-ajuda="Informe se tem freios ABS" tipo="input-group-prepend">
                                    <input
                                        type="checkbox"
                                        class="form-control"
                                        id="abs"
                                ...
                                <input-container-component titulo="Tem Abs" id="newAbs" >
                                    <input type="checkbox" class="form-control" id="newAbs" aria-describedby="newAbsHelp" placeholder="Tem ABS" v-model="dadosInc.abs">
                                </input-container-component>
