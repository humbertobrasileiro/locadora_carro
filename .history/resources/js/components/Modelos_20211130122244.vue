    ...
    <div class="form-row ml-2">
        ...
        <div class="col-9">
            ...
            <!--div class="row justify-content-center"-->
                ...
                <modal-component id="modalModeloAdc" titulo="Adicionar | modelo" tamanho="">
                ...
                <modal-component id="modalModeloAtu" titulo="Atualizar | modelo" tamanho="modal-xl">
                    ...
                    <template v-slot:conteudo>
                        <div class="form-group row">
                            <div class="col-2">
                                <input-container-component titulo="ID" id="id" id-help="idHelp" texto-ajuda="ID do modelo" tipo="N">
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="id"
                            ...
                            <div class="col-5">
                                <input-container-component titulo="Nome do modelo" id="nome" id-help="nomeHelp" texto-ajuda="Informe o nome do modelo" tipo="N">
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="nome"
                            ...
                            <div class="col-3">
                                <input-container-component titulo="ID Marca" id="marca_id" id-help="marca_idHelp" texto-ajuda="Informe o ID da marca" tipo="N">
                                    <select class="form-control" v-model="$store.state.item.marca_id" id="marca_id" aria-describedby="marca_idHelp">
                                        <option value=""></option>
                                        <option v-for="(marca, key) in marcas" :key="key" v-bind:value="marca.id">{{ marca.nome }}</option>
                                    </select>
                                </input-container-component>
                            ...
                            <div class="col-2">
                                <img :src="'/storage/' + modelos.data[$store.state.item.chave].marca.imagem" width="50" height="auto">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            <input-container-component titulo="Modelo da marca (clique aqui para alterar)" id="imagem" id-help="imagemHelp" texto-ajuda="Selecione uma imagem no formato PNG" tipo="N">
                                <input
                                    type="file"
                                    class="form-control-file"
                                    id="imagem"
                                ...
                                <img :src="imagem.url" :alt="imagem.titulo" v-if="imagem.url" align="center" width="420" height="auto">
                        </div>
                        <hr>
                        <div class="form-group row">
                            <div class="col-3">
                                <input-container-component titulo="Nº de Postas" tipo="N">
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="numero_portas"
                                        aria-describedby="numero_portasHelp"
                                        placeholder="Nº portas"
                                        v-model="$store.state.item.numero_portas">
                                </input-container-component>
                            </div>
                            <div class="col-3">
                                <input-container-component titulo="Nº de Lugares" tipo="N">>
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="lugares"
                            ...
                            <div class="col-3">
                                <input-container-component titulo="Air Bag" tipo="C">
                                    <input
                                        type="checkbox"
                                        class="form-control"
                                        id="air_bag"
                                        aria-describedby="air_bagHelp"
                                        placeholder="air bag?"
                           ...
                           <div class="col-3">
                                <input-container-component
                                    ...
                                    id="abs"
                                    id-help="absHelp"
                                    texto-ajuda="Informe se tem freios ABS"
                                    tipo="C">
                                    <input
                                        type="checkbox"
                                        class="form-control"
                ...
                <modal-component id="modalModeloRem" titulo="Remover | modelo">
                    ...
                    <template v-slot:conteudo>
                        ...
                        <div class="form-group" v-if="$store.state.item.imagem">
                            <input-container-component titulo="Imagem do modelo">
                                <img
                                    :src="'/storage/' + $store.state.item.imagem"
                                    alt="Foto do modelo"
        ...
        methods: {
            ...
            atualizar() {
                ...
                if (this.imagem['arquivo'] != '') {
                    ...
                    console.log('passei aqui na imagem')
