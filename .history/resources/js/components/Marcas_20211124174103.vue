<template>
    <div class="container">
        ...
        <modal-component id="modalMarcaAdc" titulo="Adicionar | marca">
            ...
            <template v-slot:rodape>
                <button
                    ...
                    data-dismiss="modal"
                    @click="$store.state.transacao.status == 'sucesso' ? closeBotao('inclusao') : ''">
                    Fechar
                </button>
        ...
        <modal-component id="modalMarcaVis" titulo="Visualizar | marca">
            ...
            <template v-slot:rodape>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="closeBotao('visualizacao')">Fechar</button>
            </template>
        ...
        <modal-component id="modalMarcaAtu" titulo="Atualizar | marca">
            ...
            <template v-slot:rodape>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="closeBotao('atualizacao')">Fechar</button>
            </template>
        ...
        <modal-component id="modalMarcaRem" titulo="Remover | marca">
            ...
            <template v-slot:rodape>
                <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="closeBotao('exclusao')">Fechar</button>
        ...
        methods: {
            ...
            paginacao(l) {
                if (l) {
                    ...
                    console.log('Paginando: '+this.urlPaginacao)
            ...
            closeBotao(para) {
                ...
                if (para === 'inclusao') {
                    ...
                    this.$store.state.paginaAtual = this.mascas.last_page

                }

                console.log('Ultima Pagina: ' + my, 'Pagina Atual: ' + this.$store.state.paginaAtual)
