<template>
    <div class="container">
        ...
        <modal-component id="modalMarcaRem" titulo="Remover | marca">
            ...
            <template v-slot:alertas>
                <alert-component tipo="success" :detalhes="transacaoDetalhes" titulo="Marca removida com sucesso" v-if="transacaoStatus == 'Remover'"></alert-component>
                <alert-component tipo="danger" :detalhes="transacaoDetalhes" titulo="Erro ao remover a marca" v-if="transacaoStatus == 'Erro'"></alert-component>
            </template>
                    ...
                    axios.post(url, formData, config)
                        .then(response => {
                            ...
                            this.transacaoDetalhes = {
                                mensagem: 'Registro ID: ' + response.data.id + ' removido com sucesso'
                            }
                        })
                        .catch(errors => {
                            this.transacaoStatus = 'Erro'
                            this.transacaoDetalhes = {
                                mensagem: 'Houve um erro na tentativa de remoção da marca',
