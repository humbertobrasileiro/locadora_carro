            ...
            <!--div class="row justify-content-center"-->
                ...
                <modal-component id="modalModeloVis" titulo="Visualizar | modelo">
                    ...
                    <template v-slot:conteudo>
                        ...
                        <div class="form-group row" v-if="$store.state.item.id != ''">
                            <div class="col-6">
                                <p>
                                    <b>ID:</b> {{ $store.state.item.marca_id }} <b>Marca:</b> {{ modelos.data[$store.state.item.chave].marca.nome }}
                                </p>
                            </div>
                            <div class="col-6">
                                <img :src="'/storage/' + modelos.data[$store.state.item.chave].marca.imagem" alt="Foto do modelo" v-if="modelos.data[$store.state.item.chave].marca.imagem">
                            </div>
                        </div>
                        <div class="form-group">
                            <input-container-component titulo="Imagem do modelo">
                                <img :src="'/storage/' + $store.state.item.imagem" alt="Foto do modelo" v-if="$store.state.item.imagem">
                            </input-container-component>
                        </div>
                        <div class="form-group row">
                            <div class="col-3">
