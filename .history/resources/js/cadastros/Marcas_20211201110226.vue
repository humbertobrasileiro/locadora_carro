<template>
    ...
    <div class="form-row ml-2">
        ...
        <div class="col-3">
            ...
            <card-component titulo="Busca de marcas">
                <template v-slot:conteudo>
                    ...
                    <input-label-component para="inputId" titulo="Informe o ID da marca">
                        <input
                            type="number"
                            class="form-control"
                            id="inputId"
                    ...
                    <input-label-component para="inputNome" titulo="Informe o Nome da marca">
                        <input
                            type="text"
                            class="form-control"
                            id="inputNome"
        ...
        <div class="col-9">
            ...
            <modal-component id="modalMarcaAdc" titulo="Adicionar | marca" tamanho="">
                ...
                <template v-slot:conteudo>
                    <div class="row">
                        ...
                        <div class="col-10">
                            <input-container-component titulo="Nome da marca" id="newNome" id-help="newNomeHelp" texto-ajuda="Informe o nome da marca">
                                <input type="text" class="form-control" id="newNome" aria-describedby="newNomeHelp" placeholder="Nome da marca" v-model="nomeMarca">
            ...
            <modal-component id="modalMarcaRem" titulo="Remover | marca">
                ...
                <template v-slot:conteudo>
                    <div class="form-group" v-if="$store.state.transacao.status != 'sucesso'">
                        <input-container-component titulo="ID">
                            <input type="text" class="form-control" :value="$store.state.item.id" disabled>
                        </input-container-component>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            async carregarLista() {
                ...
                await axios.get(url)
                    .then(response => {
                        ...
                        console.log('estou aqui no axios')
                    })
                    .catch(errors => {
                        this.$store.state.transacao.status = 'erro'
                        this.$store.state.transacao.mensagem = errors.response.data.erro
            ...
            async closeInclusao() {
                ...
                this.pagina = this.marcas.last_page
            ...
            closeAtualizarBotao() {
                ...
                this.urlPaginacao = 'page='+this.marcas.current_page
                this.carregarLista()
                this.closeBotao()
                imagem.value = ''
            ...
            async closeRemoveBotao() {
                ...
                this.pagina = this.marcas.current_page
                ...
                console.log('apos atualizacao da requisicao', this.marcas.last_page)
            ...
            closeBotao() {
                ...
                if (this.marcas.last_page <= this.pagina) {
