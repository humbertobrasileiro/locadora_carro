                    ...
                    <template v-slot:conteudo>
                        <table-component
                            ...
                            :titulos="{
                                ...
                                data_inicio_periodo: {titulo: 'Data inicio', tipo: 'texto'},
                                data_final_previsto_periodo: {titulo: 'Data Final prevista', tipo: 'texto'},
                                data_final_realizado_periodo: {titulo: 'Data Entrega', tipo: 'texto'},
            ...
            async carregarLista() {
                ...
                await axios.get(url)
                    .then(response => {
                        ...
                        console.log('locacoes', this.locacoes)
                        this.$store.state.transacao.status = 'lista'
                        this.$store.state.transacao.mensagem = response.data.msg
                    })
                    .catch(errors => {
