            ...
            <modal-component id="modalCarroAdc" titulo="Adicionar | carro" tamanho="modal-xl">
                ...
                <template v-slot:conteudo>
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <input-container-component titulo="ID Modelo" id="newModelo_id" id-help="newModelo_idHelp" texto-ajuda="Selecione o modelo">
                                <select
                                    class="form-control"
                                    id="newModelo_id"
                                    aria-describedby="newModelo_idHelp"
                        ...
                        <div class="col-2" v-if="imagem.modelo">
                            <img :src="'/storage/' + imagem.modelo" width="72" height="auto">
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                        <div class="col-6">
