            ...
            <modal-component id="modalCarroAdc" titulo="Adicionar | carro" tamanho="modal-xl">
                ...
                <template v-slot:conteudo>
                    <div class="form-group row">
                        ...
                        <div class="col-6" v-if="imagemModelo">
                            <img :src="'/storage/' + imagemModelo" alt="imagem modelo" width="420" height="auto">
                        </div>
                    </div>
                </template>
                            ...
                            <div class="form-group row" v-if="$store.state.item.chave >= 0">
                                ...
                                <div class="row">
                                    <img class="rounded float-center"
                                        :src="'/storage/' + imagemModelo" alt="imagem modelo" width="420" height="auto">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <modal-component id="modalCarroRem" titulo="Remover | Carro" tamanho="modal-xl">
                ...
                <template v-slot:conteudo>
                    <div class="form-group row">
                        ...
                        <div class="col-6" v-if="carros.data.length() > 0">
                            {{ 'minha chave ' + $store.state.item.chave}}
                            <div class="form-group row">
                                <div class="row">
                                    <p v-show="upLoadImage">
                                        <b>ID:</b>
                                        {{ $store.state.item.modelo_id }} <b>Modelo:</b>
                                        {{ nomeModelo }}
                                    </p>
        ...
        computed: {
            upLoadImage() {
                if (this.$store.state.item.imagem != null) {
                    this.imagemModelo = this.carros.data[this.$store.state.item.chave].marca.imagem
                    this.nomeModelo = this.carros.data[chave].modelo.nome
                }
            }
        },
        data() {
        ...
        methods: {
            ...
            atuModelo(e) {
                if (e) {
                    ...
                    this.imagemModelo = meu_modelo[0].imagem
